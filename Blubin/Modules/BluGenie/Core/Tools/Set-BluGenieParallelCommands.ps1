            ...
            )
            {
                #region Add items to list
                    {$Add}
                    {
                        ...
                        -Process `
                        {
                            If
                            (
                                $global:ConsoleParallelCommands -contains $_
                            )
                            {
                ...
                #region RemoveAll items from list
                    {$RemoveAll -eq $true}
                    {
                        ...
                        {
                            0..$($global:ConsoleParallelCommands.Count -1) | Sort-Object -Descending | ForEach-Object `
                            -Process `
                            {
                    ...
                    {$RemoveIndex}
                    {
                        ...
                        )
                        {
                            ...
                            -Process `
                            {
                                ...
                                If
                                (
                                    $global:ConsoleParallelCommands[$($_ - 1)]
                                )
                                {
                ...
                #region Default (Show list values)
                    Default
                    {
                        ...
                        )
                        {
                            ...
                            $global:ConsoleParallelCommands | ForEach-Object `
                            -Process `
                            {
                                $ConsoleParallelCommandsText = "$_".PadRight(25,' ') + "|| `t"
